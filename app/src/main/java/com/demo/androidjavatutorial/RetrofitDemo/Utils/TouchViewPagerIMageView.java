...
public class TouchViewPagerIMageView extends ImageView {
    ...
    public TouchViewPagerIMageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public TouchViewPagerIMageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
